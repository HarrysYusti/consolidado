...
//CALCULO DE RATIO CONSIDERANTO X PEDIDOS MINIMOS
  ...
  sheet.getRange("F1").setValue(posisionesLinea);
  sheet.getRange("G1").setValue(" -----> ");
  sheet.getRange("H1").setValue(conteoPedidos);
  sheet.getRange("I1").setValue(iteremos);
...
do{
  ...
  posicion = analyzeMaterials7(numiteracion).posisionesLinea;
  numiteracion++;
}while(posicion <= 1600);
