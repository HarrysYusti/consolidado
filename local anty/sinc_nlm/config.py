...
# ── Google Drive ──────────────────────────────────────────────
# ID de la carpeta de Google Drive desde la que se cargarán
# documentos hacia NotebookLM (usado por cargar_desde_drive.py).
# Cómo obtenerlo: abre la carpeta en Google Drive y copia el ID
# del final de la URL:
#   https://drive.google.com/drive/folders/<ESTE-ES-EL-ID>
DRIVE_FOLDER_ID = "1NT-mLUDmbRoAlSIdvvynOhlvgD41jRM6"
