---
name: python-pro-jeffallan
description: Senior Python developer guidance specializing in type-safe, async-first, production-ready Python 3.11+ code.
---

# Python Pro (Jeff Allan)
...
- pytest
- black, ruff
- dataclasses, async/await, asyncio
- pathlib, functools, itertools
- Poetry, Pydantic
- contextlib, collections.abc, Protocol
